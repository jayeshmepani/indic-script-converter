...
function toLosslessCanonicalIastFromDevanagari(string $text, ?ScriptToIastOptions $options = null): LosslessTransliterationResult
{
    ...
    return new LosslessTransliterationResult(
        ...
        inputNormalization: $opts->inputNormalization,
        outputNormalization: $opts->outputNormalization,
        renderingIsInjective: false,
        issues: [new TransliterationIssue(
            code: 'CANONICAL_REVERSE_DOES_NOT_RECREATE_LATIN_ALIASES',
            message: 'Canonical IAST is generated. Use toExactIastFromDevanagari() for a metadata-backed exact source key.',
...
function toLosslessCanonicalIastFromGujarati(string $text, ?ScriptToIastOptions $options = null): LosslessTransliterationResult
{
    ...
    return new LosslessTransliterationResult(
        ...
        issues: [new TransliterationIssue(
            code: 'CANONICAL_REVERSE_DOES_NOT_RECREATE_LATIN_ALIASES',
            message: 'Canonical IAST is generated. Use toExactIastFromGujarati() for a metadata-backed exact source key.',
            severity: TransliterationIssueSeverity::INFO,
        )],
    );
}
